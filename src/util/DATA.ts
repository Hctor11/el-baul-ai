...
export const content:entry[] = [
    {
        ...
        description: 'Muse es un generador de imagenes a partir de texto que resulta ser mas eficiente que los modelos de difusion o modelos autoregresivos.',
...
},
{
        ...
        description: 'Implementacion de Computer Vision models que ya no solo permiten procesar texto a ChatGPT, sino tambien imagenes.',
...
},
{
        ...
        description: 'LLaVA es modelo que permite dar asistencia por texto, teniendo la capacidad de procesar imagenes de forma logica.',
